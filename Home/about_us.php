...
<body>
    ...
    <!-- Who We Are Section (Now Below the Gradient) -->
    ...
    <section class="mission-section" id="our-mission">
        <h2>Our Mission</h2>
        <p>
            Our mission is to improve hypertension management through innovative digital health interventions that empower patients, engage families, and enhance collaboration with healthcare professionals. By integrating user-friendly technology, we aim to support hypertensive patients in monitoring their blood pressure, adhering to treatment plans, and maintaining long-term health. Through a holistic approach that combines digital tracking, real-time alerts, and support networks, we strive to reduce the burden of uncontrolled hypertension and promote better health outcomes in Jamaica and beyond.
        </p>
        <div class="image-container">
            <img src="../Images/aboutUsImages/our-mission.png" alt="Our Mission">
        </div>
    </section>
    ...
    <section class="mission-section" id="our-mission">
        ...
        <p>
            Our project is inspired by the growing public health crisis of hypertension, particularly in Jamaica, where prevalence rates have risen significantly over the years. Research indicates that despite medication subsidies, only a fraction of hypertensive patients successfully control their condition. Studies have shown that digital health interventions (DHIs) have the potential to improve self-management, but their effectiveness is greatly enhanced when healthcare professionals and family members are involved.  
        </p>
        <p>
            Many existing hypertension management apps lack professional input and scientific validation, making them less effective in real-world applications. Our research highlights the need for a patient-centered, evidence-based approach that integrates healthcare expertise and social support. By addressing these challenges, we aim to create a digital solution that not only assists patients in monitoring their blood pressure but also fosters engagement among families and healthcare providers to enhance long-term adherence and health outcomes.
        </p>
    </section>
    ...
    <section class="how-it-works-section" id="how-it-works">
        <div class="content-wrapper">
            <div class="content-container">
                ...
                <p>
                    Our digital health platform is designed to empower hypertensive patients by providing an integrated system for blood pressure tracking, family support, and healthcare collaboration.
                </p>
                <p>
                    By combining technology with professional and familial support, our platform helps patients take control of their health while ensuring they receive the guidance and motivation needed to maintain stable blood pressure levels.
                </p>
            </div>
                <div class="image-container">
    ...
    <div class="why-image">
        <img src="../Images/aboutUsImages/why-this-matters.jpg" alt="Illustration of Digital Health Concept">
    </div>
    </section>
    ...
    <section class="future-vision">
        <div class="vision-content">
            <h2>Future Vision</h2>
            <p>We are committed to continuous improvement, ensuring that our digital health platform evolves to meet the needs of hypertension patients.</p>
